...
export function CreditNoteSection({ grnId, notes, canEdit, canRequest }: { grnId: string; notes: CreditNote[]; canEdit: boolean; canRequest: boolean }) {
  ...
  function submitRequest() {
    ...
    startTransition(async () => {
      const result = await requestCreditNote(grnId, reason);
